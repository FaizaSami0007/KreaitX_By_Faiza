              ...
              <div className="space-y-4 sm:space-y-5">
                ...
                <Reveal delay={0.05} yOffset={10}>
                  <div className="flex items-center gap-3">
                    <span className="font-serif font-normal text-sm sm:text-base text-[#B2AD7F]">
                      03
                    </span>
                ...
                <Reveal delay={0.12} yOffset={16}>
                  <h2
                    ...
                    className="text-[clamp(36px,4.5vw,60px)] font-normal text-white tracking-[-0.035em] leading-[1.06]"
                  >
                    Social media <br />
                    with{" "}
                        ...
                        >
                          <div className="flex items-center gap-3.5 sm:gap-4">
                            ...
                            <div className="space-y-0.5">
                              ...
                              <p className="text-xs text-[#14213D]/65 font-normal leading-relaxed">
                                {item.description}
                              </p>
                            </div>
                          </div>
