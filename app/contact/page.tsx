...
export default function ContactPage() {
  ...
  return (
    <>
      {/* Contact Page Hero with User-Provided Art */}
            ...
            <div className="max-w-3xl mx-auto flex flex-col items-center">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center px-6 py-3.5 min-h-[50px] rounded-full text-sm font-semibold text-white bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-md transition-all duration-200 w-full sm:w-auto"
                >
