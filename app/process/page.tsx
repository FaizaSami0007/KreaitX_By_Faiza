...
export default function ProcessPage() {
  return (
    <>
      {/* Process Page Hero with User-Requested Custom 3D Silk Artwork */}
      <section className="relative overflow-hidden bg-white text-slate-900 min-h-[680px] lg:min-h-[760px] flex items-center justify-center py-20 lg:py-28 border-b border-slate-200/80">
        {/* Custom 3D Silk Background Image (Top-Right Constellation Silk on Pure White) */}
        <div className="absolute inset-0 z-0 pointer-events-none select-none overflow-hidden">
          <Image
            src="/images/process-hero-custom-bg.png"
